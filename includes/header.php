...
<head>
	...
	<!-- Page plugins -->
	<link rel="stylesheet" href="admin/assets/vendor/fullcalendar/dist/fullcalendar.min.css" type="text/css">
	<link rel="stylesheet" href="admin/assets/vendor/sweetalert2/dist/sweetalert2.min.css" type="text/css">
	<!-- Argon CSS -->
	<link rel="stylesheet" href="admin/assets/css/dashboard.css" type="text/css">
</head>
<body class="bg-white">
