<nav id="navbar-main" class="navbar navbar-horizontal navbar-transparent navbar-main navbar-expand-lg navbar-light">
    <div class="container">
      <a class="navbar-brand" href="admin/index.php">
        <img src="admin/assets/img/brand/light.svg" height="30">
      </a>
      ...
      <div class="navbar-collapse navbar-custom-collapse collapse" id="navbar-collapse">
          ...
          <div class="row">
            <div class="col-6 collapse-brand">
              <a href="admin/index.php">
                <img src="admin/assets/img/brand/dark.svg" height="40">
              </a>
            </div>
        ...
        <ul class="navbar-nav align-items-lg-center ml-lg-auto">
          ...
          <li class="nav-item d-none d-lg-block ml-lg-4">
            <a href="https://www.creative-tim.com/product/impact-design-system-pro" target="_blank" class="btn btn-neutral btn-icon">
