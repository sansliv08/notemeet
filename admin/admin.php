							...
							<div class="card card-stats">
								...
								<div class="card-body">
									...
									<p class="mt-3 mb-0 text-sm text-right">
										<span class="text-success"><?= lastNewUser(); ?></span>
										<span class="text-nowrap ml-1">Last new user</span>
									</p>
								</div>
							</div>
						</div>
								...
								<div class="card-body">
									<div class="row">
										<div class="col">
											...
											<span class="h2 font-weight-bold mb-0"><?= $numberOfPosts; ?></span>
										</div>
										<div class="col-auto">
									...
									<p class="mt-3 mb-0 text-sm text-right">
										<span class="text-success"><?= lastNewPost(); ?></span>
										<span class="text-nowrap ml-1">Last new post</span>
									</p>
								</div>
							</div>
						</div>
